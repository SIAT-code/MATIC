...
#             atom_feature_reshape = atom_feature.view(batch_size*mol_length, fingerprint_dim)
        ...
        mol_feature_viz = []
        mol_feature_viz.append(torch.sum(activated_features * atom_mask, dim=-2)) 
...
#             print(mol_feature.shape,mol_feature)
        ...
        return mol_feature, mol_attention_weight_viz, mol_feature_viz, mol_feature_unbounded_viz